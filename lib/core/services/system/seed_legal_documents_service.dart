...
/// Service to seed initial Terms and Conditions to Firestore
/// This should only be called once via the Super Admin panel
class SeedLegalDocumentsService {
  static final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  static const String _collection = 'legal_documents';

  /// Seed the initial Terms and Conditions document
  /// Returns true if seeded successfully, false if already exists
  static Future<bool> seedLegalDocuments() async {
    try {
...
These Terms shall be governed by and construed in accordance with the laws of the Republic of the Philippines.''';
      ...
      // Create the document
      final docRef = await _firestore.collection(_collection).add(termsData);
